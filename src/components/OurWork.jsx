...
const OurWork = () => {
    ...
    const workData = [
        ...
        },
        {
            ...
            description: 'We help you execute your plan and dleiver results',
            image: assets.work_dashboard_management
        },
        {
            title: 'Fitness app promotion',
            description: 'Wehelp you create a marketing strategy that drives results.',
            image: assets.work_fitness_app
        },
    ]

  return (
    <div id='pur-work' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:white-white'>
